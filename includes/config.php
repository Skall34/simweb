...
define('VA_CONTACT_EMAIL', 'zjfk7400@gmail.com');
...
define('SMTP_USERNAME', 'admin@skywings.ovh');
define('SMTP_PASSWORD', 'La6mulationCestCool!');

// Email d'expédition (From)
define('SMTP_FROM_EMAIL', 'admin@skywings.ovh');
define('SMTP_FROM_NAME', 'SkyWings VA');

// ==================== RÉSEAUX SOCIAUX ====================

// Discord (laisser vide si vous n'en avez pas)
define('VA_DISCORD_URL', 'https://discord.gg/K52UfAnSdk');
