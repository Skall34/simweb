...
<main>
    ...
    <section style="max-width:700px;margin:0 auto 32px auto;background:#e8ecd8;padding:24px;border-radius:10px;box-shadow:0 2px 12px rgba(0,0,0,0.04);border-left:4px solid #6b7b3c;">
        ...
        <ul style="margin-left:20px;">
            ...
            <li>Des exigences élevées (sécurité, ponctualité, confidentialité)</li>
            <li>Des conditions de vol parfois difficiles (zones de conflit, terrains sommaires)</li>
            <li>La responsabilité liée au transport de personnel ou matériel sensible</li>
        </ul>
    ...
    <section style="max-width:700px;margin:0 auto 32px auto;background:#fafaf5;padding:24px;border-radius:10px;box-shadow:0 2px 12px rgba(0,0,0,0.04);">
        ...
        <ul style="list-style:disc inside; padding-left:20px; font-size:1.08em; line-height:1.8;">
            ...
            <li><strong>MEDEVAC</strong> : évacuation sanitaire de blessés</li>
            <li><strong>Ravitaillement</strong> : approvisionnement de bases isolées</li>
            <li><strong>Logistique humanitaire</strong> : aide aux populations sous escorte militaire</li>
        </ul>
    </section>
    ...
    <section style="max-width:700px;margin:0 auto 32px auto;background:#fafaf5;padding:24px;border-radius:10px;box-shadow:0 2px 12px rgba(0,0,0,0.04);">
        ...
        <ul style="list-style:disc inside; padding-left:20px; font-size:1.08em; line-height:1.8;">
            ...
            <li><strong>Avions légers STOL</strong> : DHC-6 Twin Otter, Pilatus PC-6</li>
            <li><strong>Hélicoptères</strong> : CH-47 Chinook, UH-60 Black Hawk, NH90</li>
        </ul>
        <p style="margin-top:15px;color:#666;font-style:italic;">Les appareils capables d'opérer sur pistes courtes ou non préparées sont particulièrement adaptés.</p>
    </section>
</main>
