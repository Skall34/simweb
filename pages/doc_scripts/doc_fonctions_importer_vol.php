...
<div class="container" style="max-width:900px;margin:40px auto;background:#fff;padding:32px;border-radius:12px;box-shadow:0 2px 16px rgba(0,0,0,0.08);">
    <h1 style="text-align:center;color:#2c3e50;margin-bottom:32px;">Script : fonctions_importer_vol.php</h1>
    <section>
        <h2>Fonction métier</h2>
        <p>Ce script gère l'importation des vols depuis ACARS ou des fichiers CSV. Il vérifie, insère ou rejette les vols, met à jour les carnets de vol et logue chaque opération. Un mail est envoyé en cas de rejet.</p>
    </section>
    <section>
        <h2>Automatisation</h2>
        <ul>
            <li>Importation des vols depuis ACARS ou CSV.</li>
